...
export class Charts extends React.Component {
  ...
  populate(n) {
    ...
    const weirdTimeDimension = data.edgef.crossfilter.dimension((e) => e.edgeTimeReceived)
  ...
  renderGraph() {
    ...
    this.orphanPie = dc.pieChart('#orphanPie')
    ...
    this.selectionDiagram
      ...
      .edgeStrokeDashArray((e) => {
        return orphanDecorations[e.value.isOrphan].ray
      })
      .edgeStroke((e) => timeReceivedDecorations[e.value.edgeTimeReceived].color)
    ...
    this.orphanPie
      ...
      .height(150)
      .radius(75)
      .label((kv) => orphanDecorations[kv.key].label)
      .title((kv) => orphanDecorations[kv.key].label)
